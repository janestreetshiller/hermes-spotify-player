...
export const SearchField = ({onChange,containerClassName,...props}) => <input {...props} onChange={e => onChange?.(e.target.value)}/>
export const Tip = ({children,label}) => React.cloneElement(children,{title:label})
...
export const DialogTitle = ({children})=>{if(!useContext(DialogContext))throw new Error('DialogTitle must be used within Dialog');return <h2>{children}</h2>}
export const DialogDescription = ({children})=>{if(!useContext(DialogContext))throw new Error('DialogDescription must be used within Dialog');return <p>{children}</p>}
const paths={Play:'M7 4l14 8-14 8z',Pause:'M8 4v16M16 4v16',ChevronLeft:'M15 5l-7 7 7 7',ChevronRight:'M9 5l7 7-7 7',Plus:'M12 4v16M4 12h16',Search:'M20 20l-5-5M17 10a7 7 0 1 1-14 0 7 7 0 0 1 14 0',Lock:'M6 10h12v11H6zM8 10V6a4 4 0 0 1 8 0v4',AudioLines:'M4 9v6M8 4v16M12 7v10M16 3v18M20 9v6',CheckCircle2:'M6 12l4 4 8-8'}
